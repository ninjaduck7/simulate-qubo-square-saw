...
N = 20  # Set the total number of active nodes (updated for 3x3)
L = 19# Set the total number of active bonds (updated for 3x3)
A_mono = 1
A_bond_all = 1
A_corner = 1
A_diag = 1
...
with open(info_file, "w") as f:
    ...
    f.write(f"A_adjacent: {A_adjacent}\n")
    f.write(f"A_bond_all: {A_bond_all}\n")
    f.write(f"A_corner: {A_corner}\n")
